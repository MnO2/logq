...
mod test {
    ...
    fn test_parse_query_with_simple_select_where() {
        ...
        let before = ast::SelectStatement::new(select_exprs, "elb", Some(where_expr), None, None);
    ...
    fn test_parse_query_with_group_by() {
        ...
        let before = ast::SelectStatement::new(select_exprs, "elb", Some(where_expr), Some(group_by_expr), None);
        let data_source = common::DataSource::Stdin;
