...
The 512-byte ceiling still permits substantially larger inputs than the checked-in
queries (currently at most 184 bytes), while avoiding a known stack-depth limit in
