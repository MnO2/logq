...
Note: The planner does not need `Arc` because it runs synchronously and completes before any streams are created. A plain reference suffices here and avoids unnecessary cloning.
